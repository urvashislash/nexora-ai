-- =============================================================================
-- NEXORA AI — PostgreSQL Schema Migration 010: Teams & Multi-Tenancy Hierarchy
-- =============================================================================
-- Transitions system from User -> Project to User -> Team -> Project
-- Adds teams, team_members, team_invitations, and links team_id down to
-- all project-owned entities with strict RLS and performance indexes.
-- =============================================================================
...
-- 5. Performance Indexes for Multitenant Queries
